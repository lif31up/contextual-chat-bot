...
def main(path: str, response_path: str):
  with open(response_path) as file: responses = yaml.safe_load(file)
...
if __name__ == "__main__": main("model/context_model.pth", "../src/data/raw/responses.yml")